...
plot_constellation(iq_cr,  sample_skip=1, save=True,save_path='./examples/pic/ddc_iq_0/iq_cr.png')
plot_eye_diagram(iq_cr[::2], save=True,save_path='./examples/pic/ddc_iq_0/iq_cr_eye.png')

iq_rrc = rrc(iq_cr, fs_out,baud_rate)
plot_constellation(iq_rrc,  sample_skip=1,save=True,save_path='./examples/pic/ddc_iq_0/iq_rrc.png')
plot_eye_diagram(iq_rrc[::2], save=True,save_path='./examples/pic/ddc_iq_0/iq_rrc_eye.png')

iq_timed,tau,dtau,error = symbol_timing_recovery(iq_rrc)
plot_constellation(iq_timed,  sample_skip=1,save=True,save_path='./examples/pic/ddc_iq_0/iq_timed.png')
plot_eye_diagram(iq_timed, save=True,save_path='./examples/pic/ddc_iq_0/iq_timed_eye.png')
plt.figure()
plt.subplot(311)
...
plt.savefig('./examples/pic/ddc_iq_0/str.png')



iq_costas, phase,freq = costas(iq_timed)
plot_constellation(iq_costas, sample_skip=1, save=True,save_path='./examples/pic/ddc_iq_0/iq_costas.png')
...
plt.savefig('./examples/pic/ddc_iq_0/costas.png')
...
plt.plot(deg, 'x')
plt.grid()
plt.savefig('./examples/pic/ddc_iq_0/angle.png')
...
valid_hex_packet = validate_packet(hex_packet,output_file="./examples/orbdemod_packets_iq_0.txt")
